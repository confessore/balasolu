...
const who = [
  ...
  '• Startups: Content writing can help startups establish a strong online presence, build their brand, and reach their target audience.',
  '• Small businesses: Content writing is an effective way for small businesses to engage their audience, build their brand, and generate leads and sales.',
  '• E-commerce and online businesses: Content writing can help online businesses improve their search engine rankings, increase engagement, and drive more sales.',
  '• Enterprises: Enterprises can use content writing to improve their online presence, build their brand, and engage with customers and stakeholders.',
  '• Content marketers: Content marketers use content writing to create and publish high-quality, relevant, and engaging content to reach their target audience and achieve their marketing goals.',
  '• Bloggers and influencers: Content writing is also for bloggers and influencers who want to create high-quality, engaging content for their followers and build their brand.',
...
const how = [
  ...
  '• Improved online presence: High-quality content can help improve your online presence and establish your brand as an authoritative source in your industry.',
  '• Increased engagement: Well-written content can engage and inform your audience, increasing the time they spend on your site and their likelihood of taking action, such as making a purchase or filling out a contact form.',
  '• Better search engine rankings: Good content is a critical factor in search engine optimization (SEO) and can help improve your rankings and drive more organic traffic to your site.',
  '• Increased credibility: Consistently producing high-quality content can increase your credibility and establish you as a thought leader in your industry.',
  '• Cost-effective marketing: Content marketing is a cost-effective marketing strategy that can help you reach a wider audience and generate leads over time.',
  '• Better customer relationships: High-quality content can help you build relationships with your customers, providing them with valuable information and positioning you as a trusted advisor.',
...
const Content = () => {
  return (
    <>
      ...
      <h1>{title}</h1>
      <div className={`${grid}`}>
        <InfoCard header="What is content writing anyway?" content={what} />
        <InfoCard header="Who is content writing for then?" content={who} />
        <InfoCard
