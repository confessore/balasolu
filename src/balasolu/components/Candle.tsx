...
const Candle = (props: IProps) => {
    ...
    const paypal_description = `${quantity} ${type} ${quantity > 1 ? `${name}` : "candle"}`

    return (
        <div className="md:flex w-full h-auto md:w-[32rem] rounded-xl items-center m-1 p-8 md:p-0 bg-zinc-200 dark:bg-zinc-800 bg-opacity-90">
