...
const footer_mobile =
  'flex flex-col w-full justify-center items-center opacity-90 border-t border-fuchsia-900'
const footer_mobile_dark = 'dark:border-fuchsia-200'

const div_mobile =
  'flex w-full justify-center items-center text-xl bg-fuchsia-900 text-pink-200 p-5'
